...
namespace HealthMonitor
{
    public partial class HealthMonitor
    {
        ...
        internal string GetAmazonApiResponse(string p_actionWithParams)    // converted from Python code
        {
            ...
            string access_key = Utils.Configuration["AmazonAwsAccessKey"];
            string secret_key = Utils.Configuration["AmazonAwsSecretKey"];
            ...
            Utils.DownloadStringWithRetry(out hmWebsiteStr, request_url, 5, TimeSpan.FromSeconds(5), true); // caller will handle Exceptions.
            return hmWebsiteStr;
        }
