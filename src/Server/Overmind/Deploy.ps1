$projectBaseDir = "g:\work\Archi-data\GitHubRepos\SQLab\src\Server\Overmind\";
$remoteBaseDir = "/home/ubuntu/SQ/Server/Overmind/src/";
$fixFiles = "project.json", "NuGet.Config", "NLog.config";
