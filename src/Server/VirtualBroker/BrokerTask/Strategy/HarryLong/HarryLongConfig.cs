...
namespace VirtualBroker
{
    ...
    {
        public string[] AllPotentialTickersOfPortfolios = new string[] { "TVIX", "TMV", "UWT", "UGAZ", "BOIL", "USO", };
    ...
    public class PortfolioParamHarryLong : IPortfolioParam // default values here for default users
    {
        ...
        public double[] AssetsWeights = new double[] { -0.35, -0.71, -0.07, -0.22 }; // portfolio defaults, Markowitz MPT optimal weight using 135% allocation. With daily rebalancing it is safe.
    }
}
