...
namespace VirtualBroker
{
    ...
    public class PortfolioParamHarryLong : IPortfolioParam // default values here for default users
    {
        ...
        public string[] Tickers = new string[] { "TVIX", "TMV", "USO", "BOIL", "JJC" };      // portfolio defaults
        public double[] AssetsWeights = new double[] { -0.35, -0.35, -0.10, -0.30, -0.05 }; // portfolio defaults
    }
}
