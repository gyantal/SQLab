...
namespace VirtualBroker
{
    ...
    {
        public string[] AllPotentialTickersOfPortfolios = new string[] { "SVXY", "VXX", "ZIV", "TQQQ", "TMV", "UWT", "UGAZ",       "DWT", "VXZ", "TMF" };  // DWT is used only if short UWT is not available, DWT can be left here, no harm
