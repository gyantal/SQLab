...
namespace VirtualBroker
{
    ...
    public class PortfolioParamHarryLong : IPortfolioParam // default values here for default users
    {
        ...
        //> -70% short VXXB: CAGR: 100.01%	Annualized StDev: 50.05%	Sharpe: 2   this is the synthetic one, if played by short VXX.However, short VXX requires margin of x2.3
        ...
        public string[] Tickers = new string[] { "SVXY", "VXXB", "ZIV", "TQQQ", "TMV", "UWT", "UGAZ" };      // portfolio defaults after 2018-02-21
