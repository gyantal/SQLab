...
namespace VirtualBroker
{
    ...
    {
        public string[] AllPotentialTickersOfPortfolios = new string[] { "TVIX", "TMV", "USO", "UNG", "JJC" };
    ...
    public class PortfolioParamHarryLong : IPortfolioParam // default values here for default users
    {
        ...
        public string[] Tickers = new string[] { "TVIX", "TMV", "USO", "UNG", "JJC" };      // portfolio defaults
        public double[] AssetsWeights = new double[] { -0.35, -0.25, -0.08, -0.28, -0.04 }; // portfolio defaults
    }
}
