...
namespace VirtualBroker
{
    ...
    public class BrokerWrapperTest : IBrokerWrapper
    {
        ...
        public bool GetMktDataSnapshot(Contract p_contract, ref Dictionary<int, PriceAndTime> p_quotes)
        {
            ...
            {
                case "VXX":
                    p_quotes = new Dictionary<int, PriceAndTime>() { { TickType.MID, new PriceAndTime() { Price = 20.58, Time = DateTime.UtcNow } } };
                    break;
                case "SVXY":
                    p_quotes = new Dictionary<int, PriceAndTime>() { { TickType.MID, new PriceAndTime() { Price = 43.83, Time = DateTime.UtcNow } } };
                    break;
                default:
                    break;
            }
