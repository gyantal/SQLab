            ...
            var harryLongTaskSchema = new BrokerTaskSchema()
            {
                ...
                Settings = new Dictionary<object, object>() {  //not necessary, because VBrokerTask can have local parameters inside itself
                    ...
                    { BrokerTaskSetting.Portfolios, new List<BrokerTaskPortfolio>()
                        ...
                        //        Tickers = new string[] { "SVXY", "VXX", "VXZ", "TQQQ", "TMF", "SCO", "UNG", "USO" }, AssetsWeights = new double[] { 0.15*0.85, -0.05*0.85, -0.10*0.85, 0.30*0.85, 0.90*0.85, 0.08*0.85, -0.48*0.85, -0.12*0.85,}   // 2020-05-05: start diversifying into short USO too, because SCO is a bad tracker.
