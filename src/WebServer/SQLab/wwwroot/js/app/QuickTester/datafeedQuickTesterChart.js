...
Datafeeds.UDFCompatibleDatafeed.prototype.getTimescaleMarks = function (symbolInfo, rangeStart, rangeEnd, onDataCallback, resolution) {
	console.log("Datafeeds.UDFCompatibleDatafeed.prototype.getTimescaleMarks");
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
    ...
    if ((this.angularAppComponent.chartDataToChart == null) || (this.angularAppComponent.chartDataToChart.length == 0)) {
        console.log("Datafeeds.UDFCompatibleDatafeed.prototype.getBars() Getting bar data...");
        ...
        console.log("Datafeeds.UDFCompatibleDatafeed.prototype.getBars() chartDataToChart == null");
