...
export class HealthMonitorComponent {
    ...
    public getHMData(p_hmDataToSend: HMData) {
        ...
        this.m_http.post(this.m_baseUrl + 'WebServer/ReportHealthMonitorCurrentStateToDashboardInJSON', p_hmDataToSend).subscribe(result => {
            ...
            var hmData: HMData = result.json() as HMData; // Typescript cast: remember that this is a compile-time cast, and not a runtime cast.
            this.m_data = hmData;
        ...
        }, error => console.error('getHMData().There was an error: ' + error));
    }
